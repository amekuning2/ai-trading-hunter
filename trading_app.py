...
def generate_trading_plan(df, current_price, signal, supports, resistances, modal_usd=100, leverage=100, trading_mode="Ketat"):
    ...
    if trading_mode == "Scalping":
        ...
        min_tp_pct, tp_step_pct, min_sl_pct = 0.0002, 0.0003, 0.0008
    else:
        sl_mult, tp1_mult, tp2_mult, tp3_mult = 1.5, 2.0, 3.5, 5.0
        min_tp_pct, tp_step_pct, min_sl_pct = 0.0001, 0.0002, 0.005
...
with tab1:
    ...
    with col_tf:
        ...
        ], format_func=lambda x: x[0], index=1 if trading_mode == "Scalping" else 3)
...
with tab5:
    ...
    if account:
        ...
        <div style="background:#161b22; border:1px solid #30363d; border-radius:8px; padding:16px;">
            ...
            🔗 Status: <spanimport streamlit as st
import pandas as pd
import plotly.graph_objects as go
from plotly.subplots import make_subplots
...
with tab5:
    ...
    <div style="background:#161b22; border:1px solid #30363d; border-radius:8px; padding:16px;">
        <p style="color:#8b949e; font-size:12px; margin:0;">
        Version: <span style="color:#e6edf3;">v2.5 (AI Reasoning)</span><br>
...
if st.session_state.get("auto_refresh"):
    time.sleep(30)
    st.rerun()
 style="color:#3fb950;">🟢 Connected</span><br>
            Ⓥ Version: <span style="color:#e6edf3;">v2.5 (AI Reasoning)</span><br>
            </p>
        </div>
        """, unsafe_allow_html=True)
